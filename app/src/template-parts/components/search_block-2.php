      <section class="rmbt-search-block-2">
         <div class="rmbt-search-block-2__row">
            <div class="rmbt-search-block-2__col">

               <?php
               get_template_part('template-parts/components/card', 'search_2', [
